...
## Strategic Insights
- Removing the manual `/_next` rewrite reinforces standards-first ownership by letting the Next.js builder expose canonical asset URLs, preventing ecosystem fragmentation.
