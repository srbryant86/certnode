export default function PlatformBenefits() {
  const benefits = [
    ...
    },
    {
      ...
      title: 'Trust Level Architecture',
      description: 'BASIC (60%), VERIFIED (85%), or PLATINUM (95%) trust scores based on domain coverage. Higher trust = better dispute outcomes, insurance eligibility, and regulatory compliance.'
    },
    {
      icon: (
