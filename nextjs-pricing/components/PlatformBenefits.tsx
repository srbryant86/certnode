    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Four Compounding Network Effects</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Each advantage creates network effects that strengthen over time. More merchants, more receipts, more verification paths - exponentially stronger fraud protection.
          </p>
        </div>
