export default function PlatformBenefits() {
  const benefits = [
    ...
    },
    {
      ...
      title: 'Domain Coverage Architecture',
      description: 'Link 1, 2, or all 3 domains for stronger protection. Complete coverage (all three domains linked) provides exponentially stronger fraud protection, better dispute outcomes, and insurance eligibility. Available on all plans.'
    },
    {
      icon: (
