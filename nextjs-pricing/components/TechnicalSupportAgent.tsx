...
All use the same flexible API - just different receipt types and linking patterns.`
  ...
  kajabiIntegration: {
    ...
    response: `**Kajabi Turnkey Integration:**\n\n- Point Kajabi webhooks to https://certnode.io/api/integrations/kajabi using your CertNode API key as the secret.\n- We validate HMAC signatures, dedupe events in the Integration Event Ledger, and link purchases, logins, lessons, and completions to the same graph.\n- Dispute bundles automatically include payment, access, and completion receipts.`,
  },
